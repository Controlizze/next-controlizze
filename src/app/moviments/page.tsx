...
export default function MovimentsPage() {
  ...
  return (
    <div className="w-full h-full bg-background-900">
      {(sidebarOpen && <Sidebar />) || (
        <header className="fixed w-full h-20 px-5 flex items-center gap-2 bg-background-700 shadow-xl shadow-default z-20 md:hidden">
          <button
      ...
      <header className="fixed w-full h-20 px-5 flex items-center gap-2 bg-background-700 shadow-xl shadow-default z-20 hidden md:flex">
        <div className="w-fit flex flex-col justify-center gap-0">
          <h3 className="text-xs text-zinc-400 uppercase">Dashboard</h3>
          <h1 className="text-xl font-bold text-white">Movimentações</h1>
        </div>
